...
%             'string',strings2{1},'callback',@manavv,'backgroundcolor','red','tag','bu1');
        ...
        uicontrol('Units','pixels','Position',[100 400 20 20],...
         'String','V','style','text','foregroundcolor','w','fontsize',9,'backgroundcolor','r','tag','V');
               uicontrol('Units','pixels','Position',[120 400 50 20],...
         'tag',tags{1},'style','edit','string','0','backgroundcolor',[1 1 1]);
                uicontrol('Units','pixels','Position',[170 400 20 20],...
         'String','N','style','text','foregroundcolor','w','fontsize',9,'backgroundcolor','r','tag','N');
               uicontrol('Units','pixels','Position',[190 400 50 20],...
         'tag',tags{2},'style','edit','string','0','backgroundcolor',[1 1 1]);
               uicontrol('Units','pixels','Position',[240 400 20 20],...
         'String','B','style','text','foregroundcolor','w','fontsize',9,'backgroundcolor','r','tag','B');
               uicontrol('Units','pixels','Position',[260 400 50 20],...
         'tag',tags{3}','style','edit','string','0','backgroundcolor',[1 1 1]);
     
     
        s=uicontrol('Units','pixels','Position',[310 400 20 20],...
         'String','s','style','text','foregroundcolor','w','fontsize',9,'backgroundcolor','r','tag','S');
     
     uicontrol('Units','pixels','Position',[330 400 50 20],...
         'tag',tags{4}','style','edit','string','1','backgroundcolor',[1 1 1]);
     
             btn=uicontrol('Units','pixels','Position',[215 370 70 22],...
            'string',strings2{1},'callback',@manavv,'backgroundcolor','red','tag','bu1');
...
%         clear all
    function manavv(btn,~)
        x = str2num(get(findobj('tag','MV'),'string'));
        yy=str2num(get(findobj('tag','MN'),'string'));
        z=str2num(get(findobj('tag','MB'),'string'));
...
%                     a = coe2(7)
            ...
            times = [to:10:tf];
                ...
                'initialstep', T/10000);
                        ...
                        [app.sat1,app.sat2,app.sat3,app.sat4,app.sat5,app.sat6] =AliCube(7000/10,real(xv(end)),real(yv(end)),real(zv(end)));
                        plot3(xv,yv,zv,'.');
